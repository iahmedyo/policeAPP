      ...
      public void Reset()
        ...
        private void delete_records()
        {
            ...
            try
            {
                ...
                cc.con.Open();
                string ct = "delete from [User] where login=@d1";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
          ...
          txtUserID.Focus();
            ...
            return;
                ...
                cc.con = new SqlConnection(cs.DBConn());
                cc.con.Open();
                string ct = "select login from [User] where login=@d1";
                cc.cmd = new SqlCommand(ct);
                cc.cmd.Connection = cc.con;
                cc.cmd.Parameters.AddWithValue("@d1", txtUserID.Text);
                ...
                cc.con = new SqlConnection(cs.DBConn());
                cc.con.Open();
                string cb = "insert into [User](login, usertype, password, Name, contactno, email,joinnigdate) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7)";
        ...
        public void GetData()
        {
            ...
            cc.con = new SqlConnection(cs.DBConn());
            cc.con.Open();
            cc.cmd = new SqlCommand("SELECT login, usertype, password, Name, email,contactno,joinnigdate from [User] order by joinnigdate ", cc.con);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            return;
                ...
                cc.con = new SqlConnection(cs.DBConn());
                cc.con.Open();
                string cb = "update [User] set login=@d1, usertype=@d2,password=@d3,Name=@d4,contactno=@d5,email=@d6 where login=@d7";
                cc.cmd = new SqlCommand(cb);
                cc.cmd.Connection = cc.con;
                cc.cmd.Parameters.AddWithValue("@d1", txtUserID.Text);
                cc.cmd.Parameters.AddWithValue("@d2", cmbUserType.Text);
